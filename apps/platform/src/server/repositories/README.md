...
Route Handlers and React components must not query MySQL directly. Authorization checks and services call repositories or the database client from server-only modules.
