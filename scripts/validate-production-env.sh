...
required=(
  ...
  SUPERNIZO_HEAVY_URL
  SUPERNIZO_LIGHT_URL
  SUPERNIZO_NOTIFICATION_SYNC_ENABLED
  SUPERNIZO_NOTIFICATION_SYNC_SECRET
...
(( ${#SUPERNIZO_NOTIFICATION_SYNC_SECRET} >= 32 )) || {
  printf 'SUPERNIZO_NOTIFICATION_SYNC_SECRET must contain at least 32 characters.\n' >&2
  exit 1
}
...
[[ "$SUPERNIZO_NOTIFICATION_SYNC_ENABLED" == true || "$SUPERNIZO_NOTIFICATION_SYNC_ENABLED" == false ]] || {
  printf 'SUPERNIZO_NOTIFICATION_SYNC_ENABLED must be true or false.\n' >&2
  exit 1
}
